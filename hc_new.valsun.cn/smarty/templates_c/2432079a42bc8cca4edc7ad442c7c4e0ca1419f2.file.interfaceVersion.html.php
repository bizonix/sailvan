<?php /* Smarty version Smarty-3.1.12, created on 2014-09-05 17:08:52
         compiled from "E:\code2\hc_new\hc_new.valsun.cn\html\template\v1\interfaceVersion.html" */ ?>
<?php /*%%SmartyHeaderCode:485354058395cc2bc4-80217267%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2432079a42bc8cca4edc7ad442c7c4e0ca1419f2' => 
    array (
      0 => 'E:\\code2\\hc_new\\hc_new.valsun.cn\\html\\template\\v1\\interfaceVersion.html',
      1 => 1409908131,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '485354058395cc2bc4-80217267',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_54058395d6da98_29730012',
  'variables' => 
  array (
    'mod' => 0,
    'act' => 0,
...
<?php if ($_valid && !is_callable('content_54058395d6da98_29730012')) {function content_54058395d6da98_29730012($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                ...
                <div class="empower-box-msg">  
                    <form id="submitData">
                        <div class="empower-box-line">
                            <div class="empower-main-name1">请求名称:</div>
                            <div class="empower-main-text">
                                <input type='text' name='requestname' />
                            </div>
                            <div class="clear"></div>
                            <div class="empower-main-name1">转换规则：</div>
                            <div class="empower-main-text">
                                <input type='text' name='rule' />
                            </div>
                            <div class="clear"></div>
                            <div class="empower-main-name1">接口版本：</div>
                            <div class="empower-main-text">
                                <input type="text" name="version"/>
                            </div>
                            <div class="clear"></div>
                            <div class="empower-main-name1">接口返回数据封装：</div>
                            <div class="empower-main-text">
                                <input type="text" name="extend_package"/>
                            </div>
                            <div class="clear"></div>
                            <div class="empower-main-name1">接口请求转化：</div>
                            <div class="empower-main-text">
                                <input type="text" name="extend_transform"/>
                            </div>
                            <div class="clear"></div>
                            <div class="empower-main-name1" >是否启用：</div>
                            <div class="empower-main-text" style="line-height: 25px;">

<?php /* Smarty version Smarty-3.1.12, created on 2014-09-05 16:45:24
         compiled from "E:\code2\hc_new\hc_new.valsun.cn\html\template\v1\fromOpenConfig.html" */ ?>
<?php /*%%SmartyHeaderCode:209254058364aa1ac5-88104379%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bc39ab62f1c5bddfc0a8f3388be7d4613152c4a1' => 
    array (
      0 => 'E:\\code2\\hc_new\\hc_new.valsun.cn\\html\\template\\v1\\fromOpenConfig.html',
      1 => 1409906712,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '209254058364aa1ac5-88104379',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_54058364b41282_19447144',
  'variables' => 
  array (
    'mod' => 0,
    'act' => 0,
...
<?php if ($_valid && !is_callable('content_54058364b41282_19447144')) {function content_54058364b41282_19447144($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                ...
                <div class="empower-box-msg">  
                    <form id="submitData">
                        <div class="empower-box-line">
                            <div class="empower-main-name1">函数名称：</div>
                            <div class="empower-main-text">
                                <input type="text" name="functionname" />
                            </div>
                            <div class="clear"></div>
                            <div class="empower-main-name1">函数说明：</div>
                            <div class="empower-main-text">
                                <input type="text" name="name" max/>
                            </div>
                            <div class="clear"></div>
                            <div class="empower-main-name1">请求地址：</div>
                            <div class="empower-main-text">
                            ...
                            <div class="clear"></div>
                            <div class="empower-main-name1">请求API：</div>
                            <div class="empower-main-text">
                                <input type="text" name="method"/>
                            </div>
                            <div class="clear"></div>
                            <div class="empower-main-name1">返回数据格式：</div>
                            <div class="empower-main-text">
                                <select name="format">
                            ...
                            <div class="clear"></div>
                            <div class="empower-main-name1">版本：</div>
                            <div class="empower-main-text">
                                <input type="text" name="v" value="1.0" />
                            </div>
                            <div class="clear"></div>
                            <div class="empower-main-name1">发送请求方式：</div>
                            <div class="empower-main-text">
                            ...
                            <div class="clear"></div>
                            <div class="empower-main-name1">用户：</div>
                            <div class="empower-main-text">
                                <input name="username" type="text" value="purchase" disabled/>
                                
                            </div>
                            <div class="clear"></div>
                            <div class="empower-main-name1">缓存时间：</div>
                            <div class="empower-main-text">
                    ...
                    <div style="padding-left:174px; margin-top:20px;" role-name="submitButton" class="empower-box-line">
